...
func (s DataStore) Set(key string, value interface{}) error {
	if key == "" || value == nil {
		return errors.New("invalid key %s value %s", key, value)
	}
...
func (s DataStore) Get(key string, value interface{}) (found bool, err error) {
	if key == "" || value == nil {
		return false, errors.New("invalid key %s value %s", key, value)
	}
...
func (s DataStore) Delete(k string) error {
	if key == "" {
		return errors.New("invalid key %s", key)
	}
